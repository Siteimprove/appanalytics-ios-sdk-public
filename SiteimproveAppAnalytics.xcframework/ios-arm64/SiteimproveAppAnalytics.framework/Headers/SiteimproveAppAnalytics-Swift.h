...
#ifndef SITEIMPROVEAPPANALYTICS_SWIFT_H
#define SITEIMPROVEAPPANALYTICS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SiteimproveAppAnalytics",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC23SiteimproveAppAnalytics12EventManager")
...
SWIFT_CLASS("_TtC23SiteimproveAppAnalytics11Siteimprove")
@interface Siteimprove : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// Configure the SDK
...
///
/// \param isSuccessful true if search was successful, otherwise false.
///
